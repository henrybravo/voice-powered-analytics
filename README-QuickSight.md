...
1. Click on **Create table** in the left Database > Tables column
1. Choose **SQL Templates > CREATE TABLE**
1. Replace the dummy code and use this code to create the Athena table. Once added, click **Run Query**
...
**Note** The result should be in the 10000's. If you got a tiny number, something is wrong. 
...
e. Click *Choose S3 buckets* link on the right side and **Choose Select All**.   
...
1. **(if running out of Ireland)** In the main Quicksight portal page, switch to the **EU Ireland Region**)
...
* **Tweet @Henry_B_** with link to a screenshot of an interesting insight you captured from this data.  It may be added below to our ***Voice Powered Analytics** Quicksight Attendee Submissions* 
<details>
